...
Vericap은 IPO 락업 캘린더, IPO 일정, IPO 랭킹, 기관 락업 해제일 등락률, 시장 이슈별 밸류체인·테마주 지도를 제공하는 한국 주식 정보 서비스입니다.
...
- https://vericap.co.kr/value-chain : 밸류체인 · 테마주 지도
- https://vericap.co.kr/sitemap.xml : 사이트맵

## 데이터 설명

- IPO 락업 데이터는 DART, KRX, 공공데이터포털 자료를 바탕으로 정리합니다.
- 밸류체인 데이터는 국내 상장사를 우선으로 표시하며, 네이버 검색어트렌드 상대지수, KRX 거래대금, 기간 수익률, DART 재무 데이터를 캐시로 갱신합니다.
