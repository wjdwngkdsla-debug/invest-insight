...
function OriginkitBaseRoundCarousel({
  ...
  useEffect(() => {
    rotYRef.current -= (step - previousStep.current) * angle;
  ...
  return (
    <div
      ...
      onClickCapture={(event) => { if (movedRef.current) { event.preventDefault(); event.stopPropagation(); } }}
    >
      <div
        style={{
            ...
            return (
              ...
              >
                <div
                  style={{
                    ...faceBase,
                    backgroundColor: img.background ?? (src ? "transparent" : "#222"),
                ...
                <div
                  style={{
                    ...
                    backgroundColor: img.background ?? (src ? "transparent" : "#181818"),
                    backgroundImage: src ? `url(${src})` : undefined,
                    backgroundPosition: img.position ?? "center",
                    backgroundSize: img.size ?? "cover",
                    backgroundRepeat: "no-repeat",
